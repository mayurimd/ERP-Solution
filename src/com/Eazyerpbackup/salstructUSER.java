...
public class salstructUSER extends JFrame {
...
int a=0;int b=0;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					salstructUSER frame = new salstructUSER();
...
private JTextField unpaid_leave;
	...
	public salstructUSER() {
		...
		lblTotalSalary.setBounds(569, 194, 74, 24);
		...
		unpaid_leave.setEditable(false);
