...
public class EmpRegister extends JFrame {
	 ...
	 */
	public EmpRegister() {
		final Logger logger = Logger.getLogger(EmpRegister.class);
		...
		JLabel lblRegisterANew = new JLabel("Register Applicant");
		lblRegisterANew.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblRegisterANew.setBounds(10, 13, 230, 35);
		...
		JLabel lblEmailid = new JLabel("Latest Degree");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			{
				JOptionPane.showMessageDialog(null,"This Applicant already exists, Please change ID");
			}
		...
		separator_1.setBounds(0, 46, 187, 2);
		...
		separator_2.setBounds(187, 0, 10, 46);
