...
public class Addemp extends JFrame {
	...
	public Addemp() {
		...
		lblAddANew.setBounds(0, 0, 366, 35);
		contentPane.add(lblAddANew);
		
		JLabel label = new JLabel("Employee Code");
		label.setBounds(10, 71, 74, 24);
		contentPane.add(label);
		
		e_id = new JTextField();
		e_id.setColumns(10);
		e_id.setBounds(94, 73, 95, 20);
		...
		lblEmployeeType.setBounds(10, 176, 74, 24);
		...
		lblFathersName.setBounds(10, 246, 74, 24);
		...
		lblRecruitmentMode.setBounds(318, 106, 95, 24);
		...
		lblSalaryPerMonth.setBounds(318, 246, 95, 24);
		...
		lblNewLabel.setBounds(43, 36, 86, 24);
		contentPane.add(lblNewLabel);
		
		JLabel lblJobAndSalary = new JLabel("Job and Salary");
		lblJobAndSalary.setBounds(413, 36, 86, 24);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					...
					PreparedStatement pst=connection.prepareStatement(sql);  
				     ...
				     // pst.setString(22, a_sal.getText());
