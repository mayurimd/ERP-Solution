...
public class SalaryStructure extends JFrame {
	...
	public SalaryStructure() {
		...
		lblOvertime.setBounds(258, 104, 121, 24);
		contentPane.add(lblOvertime);
		
		JLabel lblMedical = new JLabel("Medical");
		lblMedical.setBounds(258, 194, 66, 24);
		contentPane.add(lblMedical);
		
		JLabel lblBonus = new JLabel("Bonus");
		lblBonus.setBounds(258, 229, 64, 24);
		contentPane.add(lblBonus);
		
		JLabel lblOther = new JLabel("Other");
		lblOther.setBounds(258, 264, 66, 24);
		...
		lblRatePerHour.setBounds(258, 147, 96, 24);
		...
		ot_rate.setBounds(387, 149, 121, 20);
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double sal= Double.parseDouble(m_sal.getText());
				double overtimevar= Double.parseDouble(overtime.getText());
				double overtimerate= Double.parseDouble(ot_rate.getText());
				
				double hourlysal= sal/30/6; //Hourly Salary
				
				double totalovertime=(hourlysal*overtimevar*overtimerate); 
				
				double  medical= Double.parseDouble(med.getText());
				double bonussal= Double.parseDouble(bonus.getText());
				double othersal= Double.parseDouble(other.getText());
				
				
				double totalsal= medical+bonussal+othersal+totalovertime+sal;
				float totalsal1=(float)totalsal;
				float totalovertimevar=(float)totalovertime;
				
				String tots = String.valueOf(totalovertimevar);
				t_overtime.setText(tots);
				
				String totsal = String.valueOf(totalsal1);
				...
				{   
				    JOptionPane.showMessageDialog(null, "All fields do not have Correct Data");
					logger.error(e1);
				}
				catch(Exception e2)
				{
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					JOptionPane.showMessageDialog(null,"This Profile has already been Saved. To make changes please use UPDATE");
				}
				if (e.getErrorCode()== SQLITE_DATATYPE_MISMATCH)
				{
		...
		btnViewSalaryTable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ViewSalaryTable v1= new ViewSalaryTable();
				v1.setVisible(true);
		...
		btnUpdate_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{   logger.error(e6);
					JOptionPane.showMessageDialog(null, "Please Ensure Correct ID and the the Data is Complete");
				}
		...
		btnUpdate_1.setBounds(721, 408, 89, 23);
		contentPane.add(btnUpdate_1);
		
		JSeparator separator = new JSeparator();
		separator.setBounds(-2, 40, 187, 2);
		...
		separator_1.setBounds(185, 0, 10, 40);
